...
1. [Генерировать сертификат](#class-)﻿ для взаимодействия с Яндекс.Кассой.
2. [Переводить деньги﻿](#class-) физическим лицам на кошельки в Яндекс.Деньгах, номера мобильных телефонов, банковские карты и счета (makeDeposition).
3. [Проверять возможность](#class-) зачисления переводов на кошельки в Яндекс.Деньгах (testDeposition).
3. Отслеживать баланс выплат (balance).
3. [Получать уведомления](#class) о неуспешном статусе переводов на банковский счет, карту, мобильный телефон (errorDepositionNotification).
...
- [с помощью менеджера пакетов Composer](#class-);
- [с помощью файла composer.json](#class-);
- [вручную](#class-).
